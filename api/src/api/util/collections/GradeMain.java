...
public class GradeMain {
	public static void main(String[] args) {
		...
		GradeVO g1 = new GradeVO("2015","홍길동",90,70,80);
		GradeVO g2 = new GradeVO("2014","김길동",100,70,80);
		GradeVO g3 = new GradeVO("2013","장길동",90,60,80);
		GradeVO g4 = new GradeVO("2012","문길동",90,70,55);
		...
		grades.add(new GradeVO("2015","최길동",45,70,80));
		...
		Collections.sort(grades, new TotalDscCompareImpl());
		for(GradeVO grade : grades){
			System.out.println(grade);
		}
	}
