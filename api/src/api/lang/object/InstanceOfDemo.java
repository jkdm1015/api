...
class Amblulance extends Car{	//Car 클래스를 상속받은 Amblulance
	void siren(){
		System.out.println("싸이렌을 울리고 가는중..");
	}
}
